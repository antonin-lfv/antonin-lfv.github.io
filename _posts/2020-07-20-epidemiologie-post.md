---
layout: post
title: Simulation épidémiologique ⭐️ 
---
...
2. [Le modèle python](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#le-modèle-python)
    1. [Simulation avec différents taux d'infection](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#simulation-avec-différents-taux-dinfection)
    2. [Simulation avec différentes létalités](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#simulation-avec-différentes-létalités)
    3. [Simulation avec différents taux d'immunité](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#simulation-avec-différents-taux-dimmunité)
    4. [Mise en place d'un confinement](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#mise-en-place-dun-confinement)
        1. [Confinement immédiat](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#confinement-dès-le-premier-cas-detecté)
        2. [Confinement après dépassement du seuil hospitalier](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#confinement-après-dépassement-de-la-capacité-hospitalière)
    5. [Simuler le SARS-cov-2](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#simuler-le-sars-cov-2)
    6. [Simulation avec différents Ro et cas limites](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#simulation-avec-différents-Ro-et-cas-limites)
3. [Le modèle SIR](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#le-modèle-sir)
    1. [Modèle mathématique](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#modélisation-mathématique-sir)
    2. [Comparaison SIR / modèle Python](https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html#comparaison-sir--modèle-python)
...
<p align="center"><a href="https://antonin-lfv.github.io/2020/07/20/epidemiologie-post.html"><img src="http://randojs.com/images/backToTopButton.png" alt="Haut de la page" height="29"/></a></p>
